...
# Crear los archivos y escribir el contenido en ellos
...
cat > src/components/ui/input.js <<EOL
import React from 'react';
...
cat > src/components/ui/tabs.js <<EOL
import React from 'react';
...
export const TabsTrigger = ({ children, ...props }) => (
  <button className="tabs-trigger" {...props}>
    {children}
  </button>
);
...
cat > src/components/ui/textarea.js <<EOL
import React from 'react';
...
echo "Estructura del proyecto y archivos creados exitosamente."
